 ...
 *
 * Define the user interface shown on the VaadIin generated web page by extending the UI class.
...
public class AddressbookUI extends UI {
    ...
    /*
     * Hundreds of widgssets. Vaadin's user interface components are just Java
